...
- ผิด/error: 0
- Accuracy: 100.00%
- Average latency: 0.223 sec
- Generated: 2026-06-30 23:54:01
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.984` sec
...
คำตอบ:
ตารางบริการแบ่งเป็น Morning 09:00–12:00 และ Afternoon 13:00–16:00 โดยภาพรวมเปิดบริการในกรอบเวลา 09:00–16:00 แต่ต้องดูตามวัน: วันจันทร์เช้าเป็น Maintenance และเปิดเล่นช่วงบ่าย 13:00–16:00, วันอังคาร–พฤหัสบดีเปิดตามรอบปกติ, วันศุกร์ช่วงบ่ายเป็น Maintenance** จึงไม่ใช่ช่วงเล่น
...
ต้องมีคำสำคัญ: 09:00, 16:00, วันจันทร์, วันศุกร์, Maintenance
Expected source keywords: Reservation
หมวด: reservation
ชนิดคำตอบ: fact
...
คำตอบ:
- ตารางบริการแบ่งเป็น Morning 09:00–12:00 และ Afternoon 13:00–16:00 โดยภาพรวมอยู่ในกรอบ 09:00–16:00 แต่ต้องดูตามวัน: วันจันทร์เช้าเป็น Maintenance และเปิดเล่นช่วงบ่าย 13:00–16:00, วันอังคาร–พฤหัสบดีเปิดตามรอบปกติ, วันศุกร์ช่วงบ่ายเป็น Maintenance** จึงไม่ใช่ช่วงเล่น
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rule_fast_path` | model: `rule_based` | elapsed: `0.004` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rule_fast_path` | model: `rule_based` | elapsed: `0.007` sec
...
คำตอบ:
- ราคา: 150 บาท (150 บาท/session × 1 session(s))
...
คำตอบ:
- ราคา: 65 บาท (65 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: ศิษย์เก่า PSU / นักศึกษาทั่วไป (General Student)
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 1 ชั่วโมง
- บริการ Cockpit คิดเป็นรอบละ 60 นาที ดังนั้นต้องใช้ 1 session(s)
...
คำตอบ:
- ราคา: 200 บาท (200 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: บุคคลทั่วไป
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 1 ชั่วโมง
- บริการ Cockpit คิดเป็นรอบละ 60 นาที ดังนั้นต้องใช้ 1 session(s)
...
คำตอบ:
- ราคา: 190 บาท (190 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: ศิษย์เก่า PSU / นักศึกษาทั่วไป (General Student)
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 30 นาที
- บริการ VR 30 นาที คิดเป็นรอบละ 30 นาที ดังนั้นต้องใช้ 1 session(s)
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['service_fee']`
- route: `deterministic_calculator` | model: `calculator` | elapsed: `0.006` sec
...
คำตอบ:
- ราคา: 525 บาท (525 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: บุคคลทั่วไป
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 30 นาที
- บริการ VR 30 นาที คิดเป็นรอบละ 30 นาที ดังนั้นต้องใช้ 1 session(s)
...
คำตอบ:
- ราคา: 375 บาท (375 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: ศิษย์เก่า PSU / นักศึกษาทั่วไป (General Student)
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 1 ชั่วโมง
- บริการ VR 1 ชั่วโมง คิดเป็นรอบละ 60 นาที ดังนั้นต้องใช้ 1 session(s)
...
คำตอบ:
- ราคา: 1,050 บาท (1,050 บาท/session × 1 session(s))
- กลุ่มผู้ใช้: บุคคลทั่วไป
- คำถามเป็นราคาแบบต่อรอบ/ต่อชั่วโมง จึงคิดเป็น 1 session = 1 ชั่วโมง
- บริการ VR 1 ชั่วโมง คิดเป็นรอบละ 60 นาที ดังนั้นต้องใช้ 1 session(s)
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['service_fee']`
- route: `deterministic_calculator` | model: `calculator` | elapsed: `0.004` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['service_fee']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.051` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `2.688` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.183` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `2.832` sec
...
คำตอบ: มี PUBG ในรายการเกมที่ปรากฏในรายการ PC ได้แก่ Tekken 8, Counter-Strike 2, League of Legends, PUBG: BATTLEGROUNDS, VALORANT และ Call of Duty: Warzone
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.525` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.693` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.062` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.382` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.046` sec
...
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.224` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.935` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.460` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.644` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['News']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.055` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.041` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.023` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `2.824` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `2.980` sec
...
คำตอบ:
ไม่พบข้อมูลเรื่องบริการส่งหรือให้เช่าเครื่องเกม/จอกลับไปใช้ที่บ้านในฐานข้อมูลที่มี

แหล่งข้อมูล:
- missing source URL (rule_no_answer_home_delivery_console)
...
คำตอบ:
ไม่พบข้อมูลเรื่องบริการซื้อเกม Steam ผ่านศูนย์ในฐานข้อมูลที่มี

แหล่งข้อมูล:
- missing source URL (rule_no_answer_steam_purchase)
...
คำตอบ:
ไม่พบข้อมูลเรื่องการผ่อนชำระค่าใช้บริการในฐานข้อมูลที่มี

แหล่งข้อมูล:
- missing source URL (rule_no_answer_installment)
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `2.839` sec
...
คำตอบ:
ไม่พบข้อมูลเรื่องการจองแบบเหมาทั้งวันในฐานข้อมูลที่มี

แหล่งข้อมูล:
- missing source URL (rule_no_answer_full_day_booking)
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.065` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.097` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.039` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.070` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['service_fee']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.081` sec
