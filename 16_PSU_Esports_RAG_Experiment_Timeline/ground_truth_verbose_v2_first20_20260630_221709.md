...
- ผิด/error: 0
- Accuracy: 100.00%
- Average latency: 0.245 sec
- Generated: 2026-06-30 22:17:09
...
คำตอบ: ในตารางบริการวัน Monday ช่วง Morning (09:00 – 12:00) เป็น Maintenance และช่วง Afternoon (13:00 – 16:00) เปิด Open for Service. ดังนั้น, คุณไม่สามารถเล่นได้ในช่วง Morning แต่สามารถใช้งานได้ในช่วง Afternoon.
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.847` sec
