...
- ผิด/error: 0
- Accuracy: 100.00%
- Average latency: 0.114 sec
- Generated: 2026-07-01 00:59:19
...
คำตอบ:
One booking can include a maximum of 3 sessions. This information is consistent across both SOURCE 1 and SOURCE 2, which state that "1.2 One booking can include a maximum of 3 Sessions."
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.555` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.026` sec
...
คำตอบ: Check-in สามารถทำได้ล่วงหน้าสูงสุดถึง 30 นาทีเท่านั้น ตามข้อกำหนดในเอกสารที่ให้ไว้.
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.373` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.072` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['home']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.065` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['home']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.027` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.321` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.030` sec
...
คำตอบ: การระงับสิทธิ์ถาวรเกิดขึ้นเมื่อผู้ใช้งานกระทำการละเมิดกฎอย่างร้ายแรง หรือมีการละเมิดซ้ำหลายครั้ง เช่น การทำลายทรัพย์สินหรือพฤติกรรมที่เป็นภัยต่อความปลอดภัยของผู้อื่น (ดูจาก [SOURCE 1])
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.205` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_direct_curated` | model: `direct_from_retrieved_curated_fact` | elapsed: `0.159` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Reservation']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.803` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.991` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `3.409` sec
...
- keyword_ok: `True`
- source_ok: `True` | matched: `['Knowledge']`
- route: `rag_llm` | model: `qwen2.5:3b` | elapsed: `4.717` sec
...
- keyword_ok: `True`
- source_ok: `True`
- route: `rule_fast_path` | model: `rule_based` | elapsed: `0.006` sec
