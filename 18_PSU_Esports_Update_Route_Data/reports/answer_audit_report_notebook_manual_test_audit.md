...
สร้างเมื่อ: 2026-07-04T17:52:11
Source results: `C:\Users\Chokhun\Downloads\Learn-LLM\18_PSU_Esports_Update_Route_Data\reports\pipeline_ground_truth_results_notebook_manual_test.jsonl`
...
### v2_201 - major_fix - score 1/4

- หมวด: `games` | route: `competition_rules` | mode: `pipeline:competition_fact_card`
...
```
- ปัญหาที่พบ:
  - auto evaluator ไม่ผ่าน

### v2_211 - major_fix - score 1/4
...
- ปัญหาที่พบ:
  - auto evaluator ไม่ผ่าน
  - ไม่พบ keyword เฉลย `PC` ในคำตอบ

### v2_333 - major_fix - score 1/4

- หมวด: `games` | route: `competition_rules` | mode: `pipeline:rag_direct_curated`
...
### 201. v2_201 [major_fix]

- หมวด: `games` | route: `competition_rules` | score: `1/4`
- คำถาม: เพลย์ห้ามี tekken 8 หรือเปล่า
- คำตอบหลัก:
...
อ้างอิงจากกติกา: Tekken 8 / PSU Esports ปะทะมันส์ สนั่นจอ
```
- เหตุผล audit: auto evaluator ไม่ผ่าน
...
อ้างอิงจากกติกา: Counter-Strike 2 / PSU Phuket CS2 2026 Tournament
```
- เหตุผล audit: auto evaluator ไม่ผ่าน; ไม่พบ keyword เฉลย `PC` ในคำตอบ
...
- หมวด: `games` | route: `schedule` | score: `4/4`
