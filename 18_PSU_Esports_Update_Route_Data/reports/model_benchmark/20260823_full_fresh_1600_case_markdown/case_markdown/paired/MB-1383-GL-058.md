...
ผล: **FAIL** | Score: `66.0` | Wall: `0.9682s` | LLM calls: `0` | Mode: `pipeline:structured_equipment_catalog`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/no_llm/MB-1383-GL-058.md)

## คำตอบ - llm_scb10x_typhoon2.5-qwen3-4b

ผล: **FAIL** | Score: `66.0` | Wall: `0.7329s` | LLM calls: `0` | Mode: `pipeline:structured_equipment_catalog`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/llm_scb10x_typhoon2.5-qwen3-4b/MB-1383-GL-058.md)

## เปรียบเทียบย่อ

- คำตอบเหมือนกันทุกตัวอักษร: `True`
- Wall time ต่างกัน (โหมดที่ 2 - โหมดที่ 1): `-0.2353s`
