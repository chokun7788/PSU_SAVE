...
ผล: **FAIL** | Score: `66.0` | Wall: `1.4002s` | LLM calls: `0` | Mode: `pipeline:structured_equipment_catalog`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/no_llm/MB-1533-GL-208.md)

## คำตอบ - llm_scb10x_typhoon2.5-qwen3-4b

ผล: **FAIL** | Score: `66.0` | Wall: `1.0842s` | LLM calls: `0` | Mode: `pipeline:structured_equipment_catalog`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/llm_scb10x_typhoon2.5-qwen3-4b/MB-1533-GL-208.md)

## เปรียบเทียบย่อ

- คำตอบเหมือนกันทุกตัวอักษร: `True`
- Wall time ต่างกัน (โหมดที่ 2 - โหมดที่ 1): `-0.316s`
