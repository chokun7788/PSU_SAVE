...
ผล: **FAIL** | Score: `84.0` | Wall: `0.5524s` | LLM calls: `0` | Mode: `pipeline:general_llm_disabled`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/no_llm/MB-1422-GL-097.md)

## คำตอบ - llm_scb10x_typhoon2.5-qwen3-4b

ผล: **PASS** | Score: `100.0` | Wall: `15.6493s` | LLM calls: `1` | Mode: `pipeline:general_llm_fallback`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/llm_scb10x_typhoon2.5-qwen3-4b/MB-1422-GL-097.md)

## เปรียบเทียบย่อ

- คำตอบเหมือนกันทุกตัวอักษร: `False`
- Wall time ต่างกัน (โหมดที่ 2 - โหมดที่ 1): `15.0969s`
