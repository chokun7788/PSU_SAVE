...
ผล: **PASS** | Score: `100.0` | Wall: `0.3397s` | LLM calls: `0` | Mode: `pipeline:structured_service_fee_by_game`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/no_llm/MB-0081-SF-081.md)

## คำตอบ - llm_scb10x_typhoon2.5-qwen3-4b

ผล: **PASS** | Score: `100.0` | Wall: `0.4625s` | LLM calls: `0` | Mode: `pipeline:structured_service_fee_by_game`
...
[เปิด log รายละเอียดและ trace จาก raw output](../details/llm_scb10x_typhoon2.5-qwen3-4b/MB-0081-SF-081.md)

## เปรียบเทียบย่อ

- คำตอบเหมือนกันทุกตัวอักษร: `True`
- Wall time ต่างกัน (โหมดที่ 2 - โหมดที่ 1): `0.1228s`
