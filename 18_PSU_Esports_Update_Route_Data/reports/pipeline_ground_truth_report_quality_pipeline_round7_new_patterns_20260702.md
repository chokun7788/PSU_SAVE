...
|---|---|---|---|---|
| v2_222 | equipment | `equipment` | 10 Units | สเปก PC ที่บันทึกไว้ตอนนี้: MSI MAG Infinite S3 14th, CPU Intel Core i5-14400, RAM DDR5 32GB, GPU NVIDIA GeForce RTX 5060 8GB, Mainboard MSI PRO H610M-G และใน PC Zone มี Gaming PC ทั้งหมด 10 เครื่อง หมายเหตุ: ข้อมูลนี้มา... |

## Files

- Results JSONL: `C:\Users\Chokhun\Downloads\Learn-LLM\18_PSU_Esports_Update_Route_Data\reports\pipeline_ground_truth_results_quality_pipeline_round7_new_patterns_20260702.jsonl`
