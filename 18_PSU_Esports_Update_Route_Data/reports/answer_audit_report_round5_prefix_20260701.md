...
สร้างเมื่อ: 2026-07-01T23:58:15
Source results: `reports\pipeline_ground_truth_results_quality_pipeline_round4_group_fix_20260701.jsonl`
Audit JSONL: `C:\Users\Chokhun\Downloads\Learn-LLM\18_PSU_Esports_Update_Route_Data\reports\answer_audit_results_round5_prefix_20260701.jsonl`
...
| events_news | 3 | 2 | 0 | 0 | 0 |
| games | 19 | 7 | 0 | 0 | 0 |
| knowledge | 6 | 1 | 0 | 0 | 0 |
| no_answer | 25 | 0 | 0 | 0 | 0 |
| overview | 5 | 0 | 0 | 0 | 0 |
| penalty | 10 | 1 | 0 | 0 | 0 |
| reservation | 85 | 9 | 0 | 0 | 0 |
| rules | 19 | 4 | 0 | 0 | 0 |
| service_fee | 137 | 2 | 0 | 0 | 0 |

## Items To Review

### v2_006 - minor_fix - score 3/4

- หมวด: `reservation` | route: `general` | mode: `pipeline:schedule_fast_path`
...
```
- ปัญหาที่พบ:
  - route เป็น general ทั้งที่ Ground Truth มีหมวดชัดเจน อาจควรปรับ router

### v2_007 - minor_fix - score 3/4
...
### v2_016 - minor_fix - score 3/4

- หมวด: `reservation` | route: `schedule` | mode: `pipeline:schedule_fast_path`
- คำถาม: ศูนย์เปิดกีโมงปิดกี่โมง
- คำตอบหลัก:

```text
โดยทั่วไปเวลาสิ้นสุดช่วงบริการคือ 16:00 แต่วันศุกร์ช่วงบ่าย 13:00-16:00 เป็น Maintenance จึงควรดูวันประกอบ
```
- ปัญหาที่พบ:
  - คำถามถามเปิด-ปิดทั่วไป คำตอบแรกควรบอกช่วงเวลาเริ่ม 09:00 และปิด/สิ้นสุด 16:00
- แนวทางแก้:
  - ขึ้นต้นด้วย Morning 09:00-12:00 และ Afternoon 13:00-16:00 แล้วค่อยบอก Maintenance

### v2_017 - minor_fix - score 3/4
...
### v2_154 - minor_fix - score 3/4

- หมวด: `service_fee` | route: `general` | mode: `pipeline:deterministic_calculator_fast`
...
### v2_166 - minor_fix - score 3/4

- หมวด: `reservation` | route: `general` | mode: `pipeline:booking_fast_path`
...
### v2_176 - minor_fix - score 3/4

- หมวด: `reservation` | route: `general` | mode: `pipeline:payment_fast_path`
...
### v2_200 - minor_fix - score 3/4

- หมวด: `games` | route: `general` | mode: `pipeline:games_fast_path`
...
### v2_230 - minor_fix - score 3/4

- หมวด: `rules` | route: `general` | mode: `pipeline:rules_fast_path`
...
### v2_251 - minor_fix - score 3/4

- หมวด: `penalty` | route: `general` | mode: `pipeline:penalty_fast_path`
...
### v2_258 - minor_fix - score 3/4

- หมวด: `contact` | route: `general` | mode: `pipeline:contact_fast_path`
...
### v2_264 - minor_fix - score 3/4

- หมวด: `knowledge` | route: `general` | mode: `pipeline:knowledge_fast_path`
...
### v2_272 - minor_fix - score 3/4

- หมวด: `events_news` | route: `general` | mode: `pipeline:news_fast_path`
- คำถาม: SURAT SMASH ส่งตัวแทนกี่คน
- คำตอบหลัก:

```text
ข่าวของ PSU Esports Studio - Phuket มี PSU Phuket CS 2 2026 วันที่ 25 เมษายน 2569, PSU Phuket VALORANT 2026 วันที่ 21 กุมภาพันธ์ 2569, SURAT SMASH ส่งตัวแทน 4 คน, นักศึกษาชาวจีน 11 คน และกิจกรรม GAME ON สำหรับนักเรียน ม.3 โรงเรียนท้ายเหมืองวิทยา
```
- ปัญหาที่พบ:
  - route เป็น general ทั้งที่ Ground Truth มีหมวดชัดเจน อาจควรปรับ router

### v2_273 - minor_fix - score 3/4
...
### v2_275 - minor_fix - score 3/4

- หมวด: `about_us` | route: `general` | mode: `pipeline:members_fast_path`
- คำถาม: อธิการบดีในหน้าสมาชิกคือใคร
- คำตอบหลัก:

```text
หน้าสมาชิกของ PSU ระบุข้อมูลผู้เกี่ยวข้องของ PSU Esports Studio - Phuket และหน้า Gallery มีหมวดภาพ Nintendo Switch และ PlayStation 5
```
- ปัญหาที่พบ:
  - route เป็น general ทั้งที่ Ground Truth มีหมวดชัดเจน อาจควรปรับ router

### v2_276 - minor_fix - score 3/4
...
- หมวด: `reservation` | route: `general` | score: `3/4`
- คำถาม: Monday open close time?
- คำตอบหลัก:
...
วันจันทร์เปิดให้เล่นช่วง 13:00-16:00 ส่วนช่วงเช้า 09:00-12:00 เป็น Maintenance*
```
- เหตุผล audit: route เป็น general ทั้งที่ Ground Truth มีหมวดชัดเจน อาจควรปรับ router
...
- หมวด: `reservation` | route: `schedule` | score: `3/4`
- คำถาม: ศูนย์เปิดกีโมงปิดกี่โมง
- คำตอบหลัก:
...
โดยทั่วไปเวลาสิ้นสุดช่วงบริการคือ 16:00 แต่วันศุกร์ช่วงบ่าย 13:00-16:00 เป็น Maintenance จึงควรดูวันประกอบ
```
- เหตุผล audit: คำถามถามเปิด-ปิดทั่วไป คำตอบแรกควรบอกช่วงเวลาเริ่ม 09:00 และปิด/สิ้นสุด 16:00
...
### 154. v2_154 [minor_fix]

- หมวด: `service_fee` | route: `general` | score: `3/4`
- คำถาม: ทำไมคำนวณ PC ไม่ได้
- คำตอบหลัก:
...
### 200. v2_200 [minor_fix]

- หมวด: `games` | route: `general` | score: `3/4`
- คำถาม: PS5 มี Spider-Man 2 ไหม
- คำตอบหลัก:
...
### 230. v2_230 [minor_fix]

- หมวด: `rules` | route: `general` | score: `3/4`
- คำถาม: เอาขนมเข้าไปกินตรงโต๊ะได้ไหม
- คำตอบหลัก:
...
### 251. v2_251 [minor_fix]

- หมวด: `penalty` | route: `general` | score: `3/4`
- คำถาม: อุทธรณ์การลงโทษได้ภายในกี่วัน
- คำตอบหลัก:
...
### 258. v2_258 [minor_fix]

- หมวด: `contact` | route: `general` | score: `3/4`
- คำถาม: ศูนย์อยู่ตรงไหน
- คำตอบหลัก:
...
### 264. v2_264 [minor_fix]

- หมวด: `knowledge` | route: `general` | score: `3/4`
- คำถาม: esports เริ่มครั้งแรกที่ไหน
- คำตอบหลัก:
...
### 272. v2_272 [minor_fix]

- หมวด: `events_news` | route: `general` | score: `3/4`
- คำถาม: SURAT SMASH ส่งตัวแทนกี่คน
- คำตอบหลัก:
...
### 275. v2_275 [minor_fix]

- หมวด: `about_us` | route: `general` | score: `3/4`
- คำถาม: อธิการบดีในหน้าสมาชิกคือใคร
- คำตอบหลัก:
