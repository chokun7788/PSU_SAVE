...
Source results: `data\eval\question_bank_runs\20260721_003429_20260721_structured_guard_fix_400\results.json`
...
Mode/route: `pipeline:structured_service_fee` / `None`
Issues: wrong_domain_or_source
User problem: คำตอบใช้ฐานข้อมูล/หมวดผิดจากสิ่งที่ควรตอบ
