...
•    Total: 400
•    Average score: 8.537 / 10
•    Score levels: {'bad': 18, 'good': 241, 'needs_review': 51, 'usable': 90}
•    Cases below 7: 69
•    Cases below 5: 18
...
•    game_rules: 8.527 / 10
•    out_of_scope: 6.793 / 10
•    play_booking_controls: 9.202 / 10

## Top Issue Tags

•    no_major_issue_detected: 189
...
Issues: wrong_equipment_focus, no_answer_for_supported_question, missing_source_id
User problem: คำถามเจาะอุปกรณ์ชิ้นหนึ่ง แต่ระบบโฟกัสอุปกรณ์อีกชิ้น; คำถามควรมีข้อมูลรองรับ แต่ระบบตอบว่าไม่มีข้อมูล; ไม่มี source id ให้ตรวจสอบย้อนกลับ
...
Issues: wrong_domain_or_source, wrong_equipment_focus
User problem: คำตอบใช้ฐานข้อมูล/หมวดผิดจากสิ่งที่ควรตอบ; คำถามเจาะอุปกรณ์ชิ้นหนึ่ง แต่ระบบโฟกัสอุปกรณ์อีกชิ้น
...
Mode/route: `pipeline:structured_schedule` / `schedule/schedule_query`
Issues: wrong_domain_or_source, wrong_equipment_focus
User problem: คำตอบใช้ฐานข้อมูล/หมวดผิดจากสิ่งที่ควรตอบ; คำถามเจาะอุปกรณ์ชิ้นหนึ่ง แต่ระบบโฟกัสอุปกรณ์อีกชิ้น
...
Issues: wrong_equipment_focus, safe_decline_but_not_useful, missing_source_id
User problem: คำถามเจาะอุปกรณ์ชิ้นหนึ่ง แต่ระบบโฟกัสอุปกรณ์อีกชิ้น; เป็นคำถามนอกเรื่องที่ควรให้ Local LLM ช่วยได้ แต่รอบนี้ปิด LLM จึงตอบไม่ได้; ไม่มี source id ให้ตรวจสอบย้อนกลับ
...
### out_of_scope
•    OOS-064 (3.1/10): วิธีจองตั๋วเครื่องบินราคาถูก -> wrong_domain_or_source, wrong_equipment_focus
•    OOS-085 (3.1/10): ทำไมคอมเปิดไม่ติด -> wrong_domain_or_source, wrong_equipment_focus
•    OOS-046 (3.8/10): วิธีดูแลคอมไม่ให้ช้า -> wrong_equipment_focus, safe_decline_but_not_useful, missing_source_id
...
•    PBC-066 (2.4/10): Nintendo Switch Sports ใช้จอยยังไง -> wrong_equipment_focus, no_answer_for_supported_question, missing_source_id
