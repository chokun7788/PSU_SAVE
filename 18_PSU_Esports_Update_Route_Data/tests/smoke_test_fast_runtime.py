...
def main() -> int:
    ...
    check("นักศึกษา สจล อยากเล่น PC เสียเท่าไหร่", ["General Student", "PC", "ยังไม่พบราคา"], "deterministic")
    check("เด็กจุฬา เล่น PC กี่บาท", ["ราคา PC", "General Student", "มหาลัยอื่น", "ยังไม่พบราคา"], "deterministic")
    ...
    check("ราคา PC ต่อชั่วโมงเท่าไหร่", ["PC", "ไม่พบ", "Service Fee"], "deterministic")
